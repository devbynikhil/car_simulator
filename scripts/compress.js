 ...
 */
{
  ...
  for (const inputFile of files) {
    ...
    const command = spawn("gltf-transform", [
      "etc1s",
      inputFile,
      ktx2File,
      "--quality",
 ...
 */
{
  ...
  const presets = [
    ...
    [
      /overlay\/overlayPattern.png$/,
      "--nowarn --2d --t2 --encode uastc --assign_oetf linear",
    ],
    [
      /palette.png$/,
      "--nowarn --2d --t2 --encode uastc --genmipmap --assign_oetf srgb --target_type RGB",
    ],
    [
      /terrain\/terrain.png$/,
