...
export class Rendering {
  ...
  setPostprocessing() {
    ...
    if (this.game.debug.active) {
      ...
      bloomPanel.addBinding(this.bloomPass.threshold, "value", {
        label: "threshold",
        min: 0,
        max: 2,
        step: 0.01,
      });
      bloomPanel.addBinding(this.bloomPass.strength, "value", {
        label: "strength",
        min: 0,
        max: 3,
        step: 0.01,
      });
      bloomPanel.addBinding(this.bloomPass.radius, "value", {
        label: "radius",
        min: 0,
        max: 1,
        step: 0.01,
      ...
      blurPanel.addBinding(this.cheapDOFPass.start, "value", {
        label: "start",
        min: 0,
        max: 0.5,
        step: 0.001,
      });
      blurPanel.addBinding(this.cheapDOFPass.end, "value", {
        label: "end",
        min: 0,
        max: 0.5,
        step: 0.001,
      ...
      blurPanel.addBinding(this.cheapDOFPass.repeats, "value", {
        label: "repeats",
        min: 1,
        max: 100,
        step: 1,
