...
export class Fog {
  constructor() {
    ...
    if (this.game.debug.active) {
      ...
      debugPanel.addBinding(this.radialCenter, "value", {
        value: "offset",
        min: 0,
        max: 1,
      });
  ...
  update() {
    ...
    const amplitude =
      this.game.view.optimalArea.farDistance -
      this.game.view.optimalArea.nearDistance;
    ...
    this.near.value =
      this.game.view.optimalArea.nearDistance +
      this.game.dayCycles.properties.fogNearRatio.value * amplitude;
    this.far.value =
      this.game.view.optimalArea.nearDistance +
      this.game.dayCycles.properties.fogFarRatio.value * amplitude;
  }
}
