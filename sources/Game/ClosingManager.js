...
export class ClosingManager {
  constructor() {
    ...
    this.game.inputs.events.on("close", (action) => {
      if (action.active) {
        ...
        // Menu open => Close
          ...
          (this.game.inputs.mode !== Inputs.MODE_GAMEPAD &&
            this.game.menu.state === Menu.OPENING)
        )
        ...
        // Projects => Close
          ...
          (this.game.world.areas?.projects.state === ProjectsArea.STATE_OPEN ||
            this.game.world.areas?.projects.state ===
              ProjectsArea.STATE_OPENING)
        )
    ...
    this.game.menu.events.on("open", () => {
      if (
        this.game.modals.state === Modals.OPEN ||
        this.game.modals.state === Modals.OPENING
      )
        this.game.modals.close();
    });
