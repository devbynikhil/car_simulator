...
export class Physics {
  constructor() {
    ...
    if (this.game.debug.active) {
      ...
      this.debugPanel.addBinding(this.world.gravity, "y", {
        min: -20,
        max: 20,
        step: 0.01,
      });
  ...
  getPhysical(_physicalDescription) {
    ...
    physical.linearDamping =
      typeof _physicalDescription.linearDamping !== "undefined"
        ? _physicalDescription.linearDamping
        : 0.1;
    physical.angularDamping =
      typeof _physicalDescription.angularDamping !== "undefined"
        ? _physicalDescription.angularDamping
        : 0.1;
    ...
    if (
      ...
      typeof _physicalDescription.type === "undefined"
    ) {
    ...
    for (let _colliderDescription of _physicalDescription.colliders) {
      ...
      if (_colliderDescription.shape === "cuboid")
        colliderDescription = colliderDescription.cuboid(
          ..._colliderDescription.parameters,
        );
      if (_colliderDescription.shape === "ball")
        colliderDescription = colliderDescription.ball(
          ..._colliderDescription.parameters,
        );
      if (_colliderDescription.shape === "cylinder")
        colliderDescription = colliderDescription.cylinder(
          ..._colliderDescription.parameters,
        );
      else if (_colliderDescription.shape === "trimesh")
        colliderDescription = colliderDescription.trimesh(
          ..._colliderDescription.parameters,
        );
      else if (_colliderDescription.shape === "hull")
        colliderDescription = colliderDescription.convexHull(
          ..._colliderDescription.parameters,
        );
      else if (_colliderDescription.shape === "heightfield")
        colliderDescription = colliderDescription.heightfield(
          ..._colliderDescription.parameters,
        );
      ...
      if (_colliderDescription.quaternion)
        colliderDescription = colliderDescription.setRotation(
          _colliderDescription.quaternion,
        );

      colliderDescription = colliderDescription.setDensity(0.1);

      if (
        typeof _colliderDescription.mass !== "undefined"
      ) // From collider description
      {
      ...
      if (
        typeof _physicalDescription.mass !== "undefined"
      ) // From body description
      {
        colliderDescription = colliderDescription.setMass(
      ...
      if (typeof _physicalDescription.friction !== "undefined")
        colliderDescription = colliderDescription.setFriction(
          _physicalDescription.friction,
        );
      else if (typeof _colliderDescription.friction !== "undefined")
        colliderDescription = colliderDescription.setFriction(
          _colliderDescription.friction,
        );
      ...
      if (typeof _physicalDescription.restitution !== "undefined")
        colliderDescription = colliderDescription.setRestitution(
          _physicalDescription.restitution,
        );
      else if (typeof _colliderDescription.restitution !== "undefined")
        colliderDescription = colliderDescription.setRestitution(
          _colliderDescription.restitution,
        );
      ...
      colliderDescription = colliderDescription.setCollisionGroups(
  ...
  update() {
    ...
    for (const physical of this.physicals) {
      const waterDepth = Math.max(
        -physical.body.translation().y,
        this.game.water.surfaceElevation,
      );
    ...
    this.eventQueue.drainContactForceEvents((event) => {
      ...
      if (typeof callback1 === "function" || typeof callback2 === "function") {
        ...
        const bodyPosition =
          position1.x === 0 && position1.y === 0 && position1.z === 0
            ? position2
            : position1;
