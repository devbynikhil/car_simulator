...
export class Tabs {
  ...
  setItems() {
    ...
    this.items.navigationContainer = this.element.querySelector(
      ".js-tabs-navigation",
    );
    this.items.navigationItems = [
      ...this.items.navigationContainer.querySelectorAll(
        ".js-tabs-navigation-item",
      ),
    ];
    this.items.contentContainer =
      this.element.querySelector(".js-tabs-content");
    this.items.contentItems = [
      ...this.items.contentContainer.querySelectorAll(".js-tabs-content-item"),
    ];
    ...
    for (const navigationElement of this.items.navigationItems) {
      ...
      item.contentElement = this.items.contentItems.find((element) =>
        element.classList.contains(item.name),
      );
      item.innerElement = item.contentElement.querySelector(
        ".js-tabs-content-inner",
      );
