...
export class SocialArea extends Area {
  ...
  setFans() {
    ...
    this.fans.pop = () => {
      ...
      this.fans.visibleCount = Math.min(
        this.fans.visibleCount + 1,
        this.fans.count,
      );
  ...
  setStatue() {
    this.statue = {};
    this.statue.body =
      this.references.items.get("statue")[0].userData.object.physical.body;
