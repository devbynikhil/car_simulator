  ...
  getKeyframesDescriptions() {
    ...
    if (this.game.debug.active) {
      ...
      for (const presetKey in presets) {
        ...
        presetsDebugPanel.addBinding(preset, "revealIntensity", {
          min: 0,
          max: 20,
          step: 0.001,
        });
        ...
        presetsDebugPanel.addBinding(preset, "lightIntensity", {
          min: 0,
          max: 20,
        });
        this.game.debug.addThreeColorBinding(
        ...
        presetsDebugPanel.addBinding(preset, "fogNearRatio", {
          label: "near",
          min: -2,
          max: 2,
          step: 0.001,
        });
        presetsDebugPanel.addBinding(preset, "fogFarRatio", {
          label: "far",
          min: -2,
          max: 2,
          step: 0.001,
