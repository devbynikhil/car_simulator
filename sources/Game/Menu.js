...
export class Menu {
  ...
  setItems() {
    ...
    const navigationElements = navigationElement.querySelectorAll(
      ".js-navigation-item",
    );
    ...
    for (const navigationElement of navigationElements) {
      ...
      item.previewElement = previewElements.find((element) =>
        element.classList.contains(`${item.name}-preview`),
      );
      item.contentElement = contentElements.find((element) =>
        element.classList.contains(`${item.name}-content`),
      );
