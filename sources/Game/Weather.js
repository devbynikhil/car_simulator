...
export class Weather {
  constructor() {
    ...
    this.addProperty("temperature", -15, 40, () => {
      ...
      const amplitude = 7.5;
      const variation =
        this.noise(this.game.dayCycles.absoluteProgress * frequency) *
        amplitude;
    ...
    this.addProperty("wind", 0, 1, () => {
      const frequency = 1;
      const variation =
        this.noise(this.game.dayCycles.absoluteProgress * frequency) * 0.5 +
        0.5;
      return variation;
    });
    ...
    this.addProperty("rain", 0, 1, () => {
      return (
        remapClamp(this.humidity.value, 0.65, 1, 0, 1) *
        remapClamp(this.clouds.value, 0, 1, 0, 1)
      );
    });
