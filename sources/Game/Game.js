  ...
  async init() {
    ...
    this.resources = await this.resourcesLoader.load([
      [
        ...
        `respawns/respawnsReferences${compressedModelSuffix}.glb`,
        "gltf",
      ],
      [
        "behindTheSceneStarsTexture",
        `behindTheScene/stars.${compressedTextureExtension}`,
      ...
      [
        "soundTexture",
        `intro/sound.${compressedTextureExtension}`,
        compressedTextureFormat,
        (resource) => {
      ...
      [
        "paletteTexture",
        `palette.${compressedTextureExtension}`,
        compressedTextureFormat,
        (resource) => {
          resource.minFilter = THREE.NearestFilter;
          resource.magFilter = THREE.NearestFilter;
    ...
    this.respawns = new Respawns(
      import.meta.env.VITE_PLAYER_SPAWN || "landing",
    );
    this.view = new View();
    ...
    const resourcesPromise = this.resourcesLoader.load(
      [
        [
          "foliageTexture",
          `foliage/foliageSDF.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
        ...
        [
          "bushesReferences",
          `bushes/bushesReferences${compressedModelSuffix}.glb`,
          "gltf",
        ],
        ["vehicle", `vehicle/default${compressedModelSuffix}.glb`, "gltf"],
        [
          "playgroundVisual",
          `playground/playgroundVisual${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "playgroundPhysical",
          `playground/playgroundPhysical${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "flowersReferencesModel",
          `flowers/flowersReferences${compressedModelSuffix}.glb`,
          "gltf",
        ],
        ...
        [
          ...
          `explosiveCrates/explosiveCrates${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "lanternsModel",
          `lanterns/lanterns${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "terrainTexture",
          `terrain/terrain.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
        ...
        [
          "floorSlabsTexture",
          `floor/slabs.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.wrapS = THREE.RepeatWrapping;
            resource.wrapT = THREE.RepeatWrapping;
        ...
        [
          ...
          `birchTrees/birchTreesVisual${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "birchTreesReferencesModel",
          `birchTrees/birchTreesReferences${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "oakTreesVisualModel",
          `oakTrees/oakTreesVisual${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "oakTreesReferencesModel",
          `oakTrees/oakTreesReferences${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "cherryTreesVisualModel",
          `cherryTrees/cherryTreesVisual${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "cherryTreesReferencesModel",
          `cherryTrees/cherryTreesReferences${compressedModelSuffix}.glb`,
          "gltf",
        ],
        ...
        [
          "poleLightsModel",
          `poleLights/poleLights${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "whisperFlameTexture",
          `whispers/whisperFlame.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.LinearFilter;
            resource.magFilter = THREE.LinearFilter;
        ...
        [
          "satanStarTexture",
          `areas/satanStar.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.LinearFilter;
            resource.magFilter = THREE.LinearFilter;
        ...
        [
          ...
          `tornado/tornadoPathReferences${compressedModelSuffix}.glb`,
          "gltf",
        ],
        [
          "overlayPatternTexture",
          `overlay/overlayPattern.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.wrapS = THREE.RepeatWrapping;
            resource.wrapT = THREE.RepeatWrapping;
        ...
        [
          ...
          `interactivePoints/interactivePointsKeyIconCross.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
        ...
        [
          ...
          `interactivePoints/interactivePointsKeyIconEnter.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
        ...
        [
          ...
          `interactivePoints/interactivePointsKeyIconA.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
        ...
        [
          "jukeboxMusicNotes",
          `jukebox/jukeboxMusicNotes.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.LinearFilter;
            resource.magFilter = THREE.LinearFilter;
        ...
        [
          ...
          `achievements/glyphs.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.LinearFilter;
            resource.magFilter = THREE.LinearFilter;
        ...
        [
          "careerHeticTexture",
          `career/careerHetic.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          ...
          `career/careerImmersiveGarden.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          ...
          `career/careerIRLTeacher.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          ...
          `career/careerOnlineTeacher.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          "careerUzikTexture",
          `career/careerUzik.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.flipY = false;
            resource.minFilter = THREE.LinearFilter;
        ...
        [
          ...
          `timeMachine/timeMachineScreenMGS.${compressedTextureExtension}`,
          compressedTextureFormat,
          (resource) => {
            resource.minFilter = THREE.NearestFilter;
            resource.magFilter = THREE.NearestFilter;
    ...
    const [newResources, RAPIER] = await Promise.all([
      resourcesPromise,
      rapierPromise,
    ]);
    this.RAPIER = RAPIER;
    ...
    if (
      ...
      this.rendering.renderer.backend.isWebGPUBackend
    )
      PreRenderer.render();
